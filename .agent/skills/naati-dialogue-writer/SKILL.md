...
The dialogue alternates between an English speaker and a Hindi speaker.
**CRITICAL**: The dialogue **MUST ALWAYS start with the English speaker** (usually the professional/service provider) as Segment 1.
