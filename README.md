...
- **Workflow**: Located in `.agent/workflows/generate-dialogue.md`. This workflow guides the agent to use the system prompt to process user input.

## Usage

To use this agent:
1.  Open this project in your agentic coding environment.
2.  Run the workflow `/generate-dialogue` (or manually follow the steps in the workflow file).
